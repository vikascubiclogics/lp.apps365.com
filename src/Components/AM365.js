...
function AM365() {
    ...
    const accordionItems = [
        ...
        },
        {
            ...
            content:`Asset Management 365, as this is a Microsoft Teams and SharePoint app, all the data of the application resides within the your office 365 tenant and Apps365 does not have any access or control over the data of its clients. Keeping the data secure is the highest priority of any organization and we at Apps365 understand and build solutions to meet elevated level of security standards. For more information, please feel free to write to us at privacy@hr365.us or visit our privacy policy`
        },{
        ...
        <div>
           ...
           <div id='pricing' className='integartionPT'></div>
            <div className='HR_whitesection'>
                ...
                <h1 className='HR_heading HR_MT' id='pricing'>Asset Management 365 Plans
                </h1>
                <div className="HR_MT">
          <div>

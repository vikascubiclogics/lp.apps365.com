...
const Termandcondition = () => {
  return (
    ...
    <div className='privacy'>
      ...
      <p>Apps365 warrants that the software will materially confirm the accompanying documentation for a period of 14 days from the date of initial download. At Apps365, the customer will only be able to claim if the refund has been raised by the Customer within 14 days from the date of Initial download, only under the following circumstances:</p>
      <ol>
        ...
        <li>You have purchased the wrong license or Apps365 product and informed us within a period of 10 days from your purchase. The Customer is not eligible for the refund under all the following circumstances.</li>
        <li>The Software is not used in accordance with Apps365’s instructions.</li>
        ...
        <li>Customer has made modifications to the Software not expressly authorized in writing by Apps365.</li>
        ...
        <li>In cases where the Customer has willingly purchased the software after taking the demo/trial from the Apps365 team.</li>
      </ol>

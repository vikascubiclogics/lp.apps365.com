    ...
    <>
      ...
      <div className="HR_panel">
        ...
        <div className="HR_HomePagesection">
          ...
          <p className="MB_pera">
            Apps365 leave management solution on cloud is a highly configurable
        ...
        <div className="HR_HomePagesection">
          ...
          <p className="MB_pera">
            Apps365 Employee Onboarding experience leads to pleasure experience
            for new joinee as well as no burden on HR team. With the help of
            Apps365 On-boarding app, there is no more paper work, employees

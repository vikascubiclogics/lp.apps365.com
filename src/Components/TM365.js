...
function TM365() {
    ...
    const accordionItems = [
            ...
            Once the pop-up opens, enter employee name and email and apply the leave on behalf of that employee and click on submit for approve.` },
        {
            ...
            content: `We can configure leave management application settings from the Apps365 portal.

            Annual casual paid leaves, medical leaves, number of restricted holidays, annual leave start date and end date can be defined in settings page of Apps365. The calendar year also can be defined here.`
        },{
